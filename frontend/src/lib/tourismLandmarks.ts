 ...
 * Images: direct upload.wikimedia.org thumbnail URLs (CC-licensed).
 * URLs computed as: upload.wikimedia.org/wikipedia/commons/thumb/[md5_1]/[md5_12]/[file]/600px-[file]
 */
...
const W = (file: string, hash1: string, hash2: string) =>
...
export const TN_LANDMARKS: Record<string, Landmark> = {
  "Thanjavur": {
    ...
    imageUrl: W("Thanjavur_Big_Temple_2.jpg", "2", "2a"),
  ...
  "Nagapattinam": {
    ...
    imageUrl: W("Velankanni_Shrine_Basilica.jpg", "b", "b6"),
  ...
  "Madurai": {
    ...
    type: "Temple Complex",
    imageUrl: W("Meenakshi_temple_Entry.jpg", "a", "a0"),
  ...
  "Tiruchirapalli": {
    ...
    type: "Rock Temple",
    imageUrl: W("Rockfort_temple.jpg", "6", "61"),
  ...
  "Kanniyakumari": {
    ...
    imageUrl: W("Vivekananda_Rock_Memorial.jpg", "2", "27"),
  ...
  "Nilgiris": {
    ...
    imageUrl: W("Nilgiri_Mountain_Railway.jpg", "7", "72"),
  ...
  "Coimbatore": {
    ...
    imageUrl: W("Adiyogi_Shiva_statue.jpg", "b", "bb"),
  ...
  "Chennai": {
    ...
    imageUrl: W("Marina_Beach_Chennai.jpg", "d", "d8"),
  ...
  "Kancheepuram": {
    ...
    imageUrl: W("Kailasanathar_Temple%2C_Kanchipuram.jpg", "2", "26"),
  ...
  "Tiruvannamalai": {
    ...
    type: "Shiva Temple",
    imageUrl: W("Annamalaiyar_Temple.jpg", "9", "94"),
  ...
  "Thoothukudi": {
    ...
    type: "Coastal Temple",
    imageUrl: W("Thiruchendur_Murugan_Temple.jpg", "1", "1a"),
  ...
  "Ramanathapuram": {
    ...
    imageUrl: W("Ramanathaswamy_Temple.jpg", "2", "25"),
  ...
  "Cuddalore": {
    ...
    imageUrl: W("Pichavaram_mangrove_backwaters.jpg", "8", "8c"),
  ...
  "Dharmapuri": {
    ...
    imageUrl: W("Hogenakkal_falls.jpg", "e", "e7"),
  ...
  "Ariyalur": {
    ...
    type: "UNESCO World Heritage Site",
    imageUrl: W("Gangaikonda_Cholapuram_Temple.jpg", "0", "00"),
  ...
  "Tirunelveli Kattabo": {
    ...
    imageUrl: W("Tirunelveli_temple.jpg", "8", "8d"),
  ...
  "Dindigul": {
    name: "Dindigul Fort",
    type: "Heritage Fort",
    imageUrl: W("Dindigul_fort.jpg", "3", "32"),
  ...
  "Namakkal": {
    name: "Namakkal Fort",
    type: "Rock Fort",
    imageUrl: W("Namakkal_fort.jpg", "a", "a5"),
  ...
  "Erode": {
    ...
    imageUrl: W("Bhavani_Sangamam.jpg", "1", "14"),
  ...
  "Salem": {
    ...
    type: "Hill Station",
    imageUrl: W("Yercaud_Lake.jpg", "9", "9b"),
  ...
  "Theni": {
    ...
    type: "Eco-Tourism",
    imageUrl: W("Meghamalai_landscape.jpg", "7", "7f"),
  ...
  "Vellore": {
    name: "Vellore Fort",
    type: "Heritage Fort",
    imageUrl: W("Vellore_Fort.jpg", "4", "48"),
  ...
  "Sivaganga": {
    ...
    imageUrl: W("Sivaganga_Palace_entrance.jpg", "e", "e0"),
  ...
  "Karur": {
    ...
    type: "Ancient Shiva Temple",
    imageUrl: W("Karur_Ayyaranathar.jpg", "a", "a1"),
  ...
  "Perambalur": {
    ...
    type: "Ancient Temple",
    imageUrl: W("Tirumanur_Temple.jpg", "4", "4f"),
  ...
  "Pudukkottai": {
    ...
    type: "Heritage Palace",
    imageUrl: W("Pudukkottai_Palace.jpg", "3", "37"),
  ...
  "Villupuram": {
    ...
    imageUrl: W("Gingee_Fort.jpg", "6", "66"),
  ...
  "Virudhunagar": {
    ...
    type: "Beach & Temple",
    imageUrl: W("Tiruchendur_beach.jpg", "5", "50"),
  ...
  "Thiruvallur": {
    ...
    type: "Ancient Temple",
    imageUrl: W("Thiruvallur_Temple.jpg", "a", "a6"),
  ...
  "Thiruvarur": {
    ...
    type: "Shiva Temple",
    imageUrl: W("Tyagaraja_Temple_Thiruvarur.jpg", "b", "b1"),
  ...
  "Krishnagiri": {
    ...
    type: "Heritage Fort",
    imageUrl: W("Krishnagiri_Fort.jpg", "a", "ab"),
...
export const GJ_LANDMARKS: Record<string, Landmark> = {
  "Ahmadabad": {
    ...
    imageUrl: W("Sabarmati_Ashram%2C_Ahmedabad.jpg", "f", "fa"),
  ...
  "Surat": {
    name: "Dumas Beach",
    type: "Beach Landmark",
    imageUrl: W("Dumas_Beach%2C_Surat%2C_Gujarat%2C_India.jpg", "7", "7b"),
  ...
  "Rajkot": {
    ...
    imageUrl: W("Kaba_Gandhi_Ni_Vato.jpg", "2", "2c"),
  ...
  "Vadodara": {
    ...
    type: "Royal Palace",
    imageUrl: W("The_Laxmi_Vilas_Palace%2C_Vadodara.jpg", "d", "dc"),
  ...
  "Gandhinagar": {
    ...
    imageUrl: W("Akshardham_night_view.jpg", "7", "7e"),
  ...
  "Kachchh": {
    ...
    type: "Natural Wonder",
    imageUrl: W("Rann_of_Kachchh%2C_Moonrise.jpg", "2", "26"),
  ...
  "Jamnagar": {
    ...
    imageUrl: W("Jamnagar_Harbour.jpg", "9", "9f"),
  ...
  "Bhavnagar": {
    ...
    imageUrl: W("Palitana_temples.jpg", "5", "55"),
  ...
  "Junagadh": {
    ...
    imageUrl: W("Asiatic_Lion_Walking.jpg", "f", "fb"),
  ...
  "Porbandar": {
    ...
    type: "Beach & Heritage",
    imageUrl: W("Porbandar_Beach.jpg", "e", "ee"),
  ...
  "Devbhumi Dwarka": {
    ...
    type: "Sacred Temple",
    imageUrl: W("Dwarkadhish_temple.jpg", "a", "a6"),
  ...
  "Anand": {
    ...
    imageUrl: W("AMUL_Headquarters.jpg", "b", "b4"),
  ...
  "Mehsana": {
    ...
    imageUrl: W("Modhera_Sun_Temple_-_exterior.jpg", "7", "73"),
