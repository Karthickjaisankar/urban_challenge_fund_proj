    ...
    <div className="app-grid">
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        {(() => {
          ...
          return (
            <div className="absolute left-1/2 -translate-x-1/2 z-[700] flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-slate-200 top-4 max-md:top-16"
